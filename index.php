...
?>
    ...
    <div class="container" id="content">
        <div class="row infos">
            <div class="block col-sm-5 col-md-3 col-lg-3 col-xs-3 col-xxl-3">
            ...
            <div class="block block-2 col-sm-5 col-md-3 col-lg-3 col-xs-3 col-xxl-3">
    ...
    <main class="container" id="about">
      <div class="row content-about" id="about">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 col-xxl-12">
          ...
          <p>
            A Rede de Saúde Paineiras atende 31 convênios além pacientes particulares e tem ainda o serviço "Cliente Especial", um cartão com descontos criado com o objetivo de beneficiar exclusivamente a população que não têm acesso a planos de saúde.
          </p>
        </div>
      </div>
