<div class="container">
    ...
    <div class="row" id="visit">
        <div class="col-12">
            <h3 class="text-center">Horários de Visita</h3>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 col-xxl-12 text-center">
            <img src="assets/img/relogio.png" class="clock-img" alt="imagem de relógio">
        </div>

        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 col-xxl-12 text-center">
            <h4>Internação e Semi-Intensiva</h4>
            <ul class="list-group">
                <li class="list-group group-item"><span>Tarde:</span> das 13h30 às 15h00</li>
                <li class="list-group group-item"><span>Noite:</span> das 19h30 às 21h00</li>
            </ul> <br>

            <p>
                <span>Importante:</span> Durante os horários de visita será permitida a permanência de, no máximo, dois visitantes por leito, incluindo o acompanhante (acompanhante + 1 ou 2 visitantes).
            </p>
        </div>
    </div>
</div>